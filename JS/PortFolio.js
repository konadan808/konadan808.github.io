...
// This function displays the firts image in the slideshow when the page loads
var slideIndex=1;
...
function showSlides(n) {
    ...
    var dots=document.getElementsByClassName("dots"); // This takes all elements with the class name "dot" and stores them in the variable array "dots"
    ...
    for (i=0; i<dots.length; i++) {
        dots[i].className=dots[i].className.replace(" active", ""); // This for loop takes each item in the array "dots" and remeoves the "active" which removes the active styling
    }
